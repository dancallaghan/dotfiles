...
map('n', '<leader>fd', function() require('telescope.builtin').find_files({ cwd = vim.fn.expand('%:p:h') }) end, silent_noremap)
...
map('n', '<leader>fc', function() require('telescope.builtin').live_grep({ cwd = vim.fn.expand('%:p:h') }) end, silent_noremap)
